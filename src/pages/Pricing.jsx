...
const PLANS = [
  {
    ...
    features: [
      ...
      { text: 'Shareable progress cards',                  included: true  },
      { text: '1 meeting prep per week',                   included: true  },
      { text: 'Full scenario library (8 scenarios)',       included: false },
      { text: 'Deep coaching reports',                     included: false },
      { text: 'Progress dashboard & trend lines',          included: false },
      { text: 'Unlimited meeting prep',                    included: false },
      { text: 'Live meeting overlay',                      included: false },
    ],
  },
  {
    id:        'pro',
    ...
    ctaStyle:  'primary',
    features: [
      { text: 'Everything in Vak\'s Nest',                 included: true  },
      { text: 'Unlimited practice sessions',               included: true  },
      { text: 'Full scenario library (8 scenarios)',       included: true  },
      { text: 'Salary negotiation, client objections, performance reviews + more', included: true },
      { text: 'Deep coaching reports (actionable, specific)', included: true },
      { text: 'Progress dashboard & trend lines',          included: true  },
      { text: 'Unlimited meeting prep',                    included: true  },
      { text: 'Live meeting overlay (beta)',                included: true  },
      { text: 'Indian English mode',                       included: false, soon: true },
    ],
  },
  {
    id:        'pro_plus',
    name:      'Vak Pro Plus',
    tagline:   'With a real human in your corner',
    price:     '₹799',
    period:    '/ month',
    badge:     '🏆 COMING SOON',
    badgeColor:'#8B5CF6',
