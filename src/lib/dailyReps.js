...
export const DAILY_REPS = [
  ...
  { id: 'r01', category: 'Assertiveness', emoji: '😤',
    situation: 'Your manager just presented your work as their own — in front of the whole team.',
  ...
  { id: 'r10', category: 'Money', emoji: '📞',
    ...
    prompt: 'Explain the discrepancy in your salary credit in thirty seconds — firmly, politely.',
